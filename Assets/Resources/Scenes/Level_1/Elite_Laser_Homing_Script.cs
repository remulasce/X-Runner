...
public class Elite_Laser_Homing_Script : MonoBehaviour {
    ...
    {
        if (other.gameObject.CompareTag("L1_Elite_Laser") || other.gameObject.name.Equals("Player_L4") || other.gameObject.name.Equals("L2_PlayerShot")) // Do not want enemy lasers to hit and destroy each other
        {
            return;
        }
