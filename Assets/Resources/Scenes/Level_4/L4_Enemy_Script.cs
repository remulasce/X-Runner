...
public class L4_Enemy_Script : MonoBehaviour
{
    ...
    void FireOurWeapon()
    {
        ...
        switch (wave.at.type)
        {
            ...
            case (SpawnTDS.AttackType.T.LaserDrop):
                //Make an enemy shot
                Instantiate(Resources.Load("Prefabs/Level_4/L4_Enemy_Shot_Drop"), this.transform.position - new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0));
                break;
            case (SpawnTDS.AttackType.T.LaserTarget):
                //Make an enemy shot
                Instantiate(Resources.Load("Prefabs/Level_4/L4_Enemy_Shot_Target"), this.transform.position - new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0));
                break;
            case (SpawnTDS.AttackType.T.HomingMissile):
                //Make an enemy shot
                Instantiate(Resources.Load("Prefabs/Level_4/L4_Enemy_Shot_Homing"), this.transform.position - new Vector3(0, 0, 0), Quaternion.Euler(0, 0, 0));
                break;
        }
    }
